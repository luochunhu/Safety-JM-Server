...
{
    public partial class UCDateTimeShiFen : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UCDateTimeShiFen()
        {
        }

        public UCDateTimeShiFen(string name)
        {           
            InitializeComponent();
        ...
        private void SetTag()
        {
            ...
            {
                string str;
                string datFrom = this.datFrom.DateTime.ToString("yyyy-MM-dd HH:mm:ss");
                string datTo = this.datTo.DateTime.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        {
            string datFrom = TypeUtil.ToDateTime(e.NewValue).ToString("yyyy-MM-dd HH:mm:ss");
            string datTo = this.datTo.DateTime.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        {
            string datFrom = this.datFrom.DateTime.ToString("yyyy-MM-dd HH:mm:ss");
            string datTo = TypeUtil.ToDateTime(e.NewValue).ToString("yyyy-MM-dd HH:mm:ss");
            string str = datFrom.Substring(0, 4);
            if (str == "0001" || str == "1900")
            {
                return;
