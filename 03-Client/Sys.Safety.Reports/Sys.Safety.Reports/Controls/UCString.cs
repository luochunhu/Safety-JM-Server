...
{
    public partial class UCString : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void SetConditionToTag()
        {
            ...
            string strValue1=this.txtValue1 .Text .Trim ();
            string strValue2=this.txtValue2 .Text .Trim ();
        ...
        private void UCString_Load(object sender, EventArgs e)
        {
            string strOperator = cboCondition.Text.Trim();
