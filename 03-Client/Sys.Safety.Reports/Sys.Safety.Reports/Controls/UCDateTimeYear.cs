...
{
    public partial class UCDateTimeYear : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public string HeaderValue
        {
            set
            {
                ...
                try
                {
                    ...
                    {
                        DateTime d1 = new DateTime(DateTime.Now.Year, 12, 1);
        ...
        public UCDateTimeYear()
        {
        }

        public UCDateTimeYear(string name)
        {
            InitializeComponent();

            this.layoutControlItem1.Text = name;

            this.datFrom.Properties.VistaCalendarViewStyle = VistaCalendarViewStyle.YearsGroupView;
            this.datFrom.Properties.EditMask = "yyyy";
            this.datTo.Properties.VistaCalendarViewStyle = VistaCalendarViewStyle.YearsGroupView;
            this.datTo.Properties.EditMask = "yyyy";

            this.datFrom.Properties.DisplayFormat.FormatString = "yyyy";
            this.datFrom.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            this.datFrom.Properties.EditFormat.FormatString = "yyyy";
            this.datFrom.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.DateTime;

            this.datTo.Properties.DisplayFormat.FormatString = "yyyy";
            this.datTo.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            this.datTo.Properties.EditFormat.FormatString = "yyyy";
        ...
        private void SetTag()
        {
            try
            {
                ...
                DateTime d1 = new DateTime(this.datTo.DateTime.Year, 12, 1);
                DateTime dtTo = d1.AddMonths(1).AddDays(-1);
