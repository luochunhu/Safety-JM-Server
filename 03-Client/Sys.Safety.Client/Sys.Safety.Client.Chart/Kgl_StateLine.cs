...
{
    public partial class Kgl_StateLine : XtraForm
    {
        ...
        public Kgl_StateLine()
        {
            InitializeComponent();
        }

        public Kgl_StateLine(Dictionary<string, string> param)
        {
            InitializeComponent();
        ...
        private void DevUCChart_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                LogHelper.Error("Kgl_StateLine_DevUCChart_MouseDown" + ex.Message +
                                                        ex.StackTrace);
            }
        }
        ...
        private void SetLocationClientValue(Point p, ref object x0, ref object y0, ref object x1, ref object y1)
        {
            ...
            {
                LogHelper.Error("Kgl_StateLine_SetLocationClientValue" + ex.Message +
                                                        ex.StackTrace);
            }
        }
        ...
        private void DevUCChart_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                LogHelper.Error("Kgl_StateLine_DevUCChart_MouseMove" + ex.Message +
                                                        ex.StackTrace);
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Kgl_StateLine_Load(object sender, EventArgs e)
        {
            try
            {
                //设置窗体高度和宽度
        ...
        private void LoadDetailList(DataTable dt)
        {
            ...
            {
                LogHelper.Error("Kgl_StateLine_LoadDetailList" + ex.Message + ex.StackTrace);
            }
        }
        /// <summary>
        ///     状态明细列表样式设置
        ...
        private void dateEdit2_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("Kgl_StateChg_dateEdit2_EditValueChanged" + ex.Message +
                                                        ex.StackTrace);
            }
        }
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            try
            {
                saveFileDialog1.FileName = "开关量曲线图.png";
