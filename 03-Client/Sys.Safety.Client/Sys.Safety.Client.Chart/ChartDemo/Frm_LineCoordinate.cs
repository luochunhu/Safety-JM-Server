...
{
    public partial class Frm_LineCoordinate : RibbonForm
    {
        ...
        protected void InitControls()
        {
            ...
            LoadSeries2(Series3, "001A03:安装位置【设备类型】(单位：PPM)", "001A03");
        ...
        void LoadSeries2(Series series, string name, string shortName)
        {
            int CodeLen = 5;
            LoadPoints(series, CodeLen);
            series.CrosshairLabelPattern = shortName + " : {V:F2}";
        ...
        private void Frm_LineCoordinate_Load(object sender, EventArgs e)
        {
            InitControls();
        }
