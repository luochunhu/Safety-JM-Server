...
{
    public partial class Mnl_BjLine : XtraForm
    {
        ...
        public Mnl_BjLine(Dictionary<string, string> param)
        {
            InitializeComponent();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Mnl_BjLine_Load(object sender, EventArgs e)
        {
            try
            {
                //设置窗体高度和宽度
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var stateName = "1态:报警," + "0态:正常/报警解除";
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            try
            {
                saveFileDialog1.FileName = "模拟量报警曲线图.png";
