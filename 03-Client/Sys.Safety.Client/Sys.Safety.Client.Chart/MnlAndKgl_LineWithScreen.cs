...
{
    public partial class MnlAndKgl_LineWithScreen : XtraForm
    {
        /// <summary>
        ///     测点1 当前设备类型ID
        /// </summary>
        ...
        public MnlAndKgl_LineWithScreen()
        {
            InitializeComponent();
        }

        public MnlAndKgl_LineWithScreen(Dictionary<string, string> param)
        {
            InitializeComponent();
        ...
        private void LoadPointList(bool loadData)
        {
            ...
            try
            {
                ...
                LoadPointSelList1(dateEdit1.DateTime, dateEdit1.DateTime, loadData);
                LoadPointSelList2(dateEdit1.DateTime, dateEdit1.DateTime, loadData);
            }
            catch (Exception ex)
            {
        ...
        private void LoadPointSelList2(DateTime stime, DateTime etime,bool loadData)
        {
            try
            {
                ...
                if (radioGroup1.SelectedIndex == 0)//按已定义测点查询
                {
                    LoadPointStr = InterfaceClass.queryConditions_.GetActivePointList(2, ref PointIDList1,
                      ref DevList1, ref WzList1);
                }
                else//按已存储测点查询
                {
                    LoadPointStr = InterfaceClass.queryConditions_.GetPointList(stime, etime, 2, ref PointIDList1,
                        ref DevList1, ref WzList1);
                }
        ...
        private void LoadPointSer(bool loadData)
        {
            ...
            {
                LogHelper.Error("MnlKglKzl_LineWithScreen_LoadPointStr" + ex.Message + ex.StackTrace);
            }
        }
        ...
        private void simpleButton7_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var SzNameE = dateEdit1.DateTime;
                //数据校验
                ...
                //测点2
                Kgl_dt_line = InterfaceClass.KglStateLineQueryClass_.getStateLineDt(SzNameS, CurrentPointID2,
                    CurrentDevid2, CurrentWzid2, kglztjsfs);

                var pointDev = InterfaceClass.QueryPubClass_.getKglStateDev(CurrentPointID2);
                ...
                shortName =
                    comboBoxEdit2.SelectedItem.ToString()
                        .Substring(0, comboBoxEdit2.SelectedItem.ToString().IndexOf('.')) + "-状态变动";
            ...
            try
            {
                ...
                foreach (var element in e.CrosshairElements)
                {
                    ...
                    if (element.Series.Name.Contains("移动值")
                        ...
                        || element.Series.Name.Contains("状态变动"))
                    {                      
