...
{
    public partial class AudioPointEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        IBroadCastPointDefineService bdefService = ServiceFactory.Create<IBroadCastPointDefineService>();

        public AudioPointEdit(string PointName, string UnitName, string BindType, string ZoomLevel, string animationState, string TurnToPage, string PointId)
        {
            InitializeComponent();
            EditPoint = PointName;
        ...
        private void PointEdit_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                var bdefinos = bdefService.GetAllPointDefineCache().Data;
                gridControl1.DataSource=bdefinos;
