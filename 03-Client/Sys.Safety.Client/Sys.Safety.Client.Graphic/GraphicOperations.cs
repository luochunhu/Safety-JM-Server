...
namespace Sys.Safety.Client.Graphic
{
    ...
    public class GraphicOperations
    {
        ...
        /// 实时值刷新线程
        /// </summary>
        public RefPointSsz refPointssz = new RefPointSsz();
        ...
        public void LoadMap(Axmetamap2dLib.AxMetaMapX2D mx, string GraphName)
        {
            try
            {
                ...
                if (!IsGraphicEdit)
                {
                    refPointssz.Start();//开启实时刷新线程
                }
                else
                {
                    refPointssz.Stop();//停止实时刷新线程
                }
            }
            catch (Exception ex)
            {
        ...
        public void SetMapTopologyInit(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            ...
            PointListStr = PointListStr + @"数据接口|||文字&字|1|0|0|445.846|534.098|142|28|1|,";
        ...
        public List<string> GraphPagesLoad()
        {
            ...
            try
            {
                //IList<Basic.Basic.DTO.GraphicsbaseinfDTO> GraphicsbaseinfDTOs = ServiceFactory.CreateService<IGraphSaveFlagService>().GetAll();
                //foreach (Basic.Basic.DTO.GraphicsbaseinfDTO GraphicsbaseinfDTO_ in GraphicsbaseinfDTOs)
                //{
        ...
        public void DoDrawingCircle(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.DrawingCircle()");
        }
        ...
        public void DoDrawingPolygon(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.DrawingPolygon()");
        }
        ...
        public void DoClearDrawing(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.ClearDrawingGraphics()");
        }
        ...
        public string DoOtherDrawingGraphics(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return "";
            return mx.CurViewEvaluateJavaScript("Basic.DrawArea.DoOtherDrawingGraphics()");
        }
        ...
        public string DoSaveDrawing(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return "";
            return mx.CurViewEvaluateJavaScript("Basic.DrawArea.SaveDrawingData()");
        }
        ...
        public void DoDrawingGraphicsInRefresh(Axmetamap2dLib.AxMetaMapX2D mx, string json, string type)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.DrawingGraphicsInRefresh('" + json + "','" + type + "')");
        }
        /// <summary>
        /// 绘制图形并传入名称
        /// </summary>
        ...
        public void DoDrawinggGraphicsAndName(Axmetamap2dLib.AxMetaMapX2D mx, string json, string type, string name, string areaId)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.DrawinggGraphicsAndName('" + json + "','" + type + "','" + name + "','" + areaId + "')");
        }
        /// <summary>
        /// 绘制图形在界面编辑状态
        /// </summary>
        ...
        public void DoDrawingGraphicsInEdit(Axmetamap2dLib.AxMetaMapX2D mx, string json, string type)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.DrawinggGraphicsInEdit('" + json + "','" + type + "')");
        }
        ...
        public string DoGetMapPointNameAndDevName(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return "";
            return mx.CurViewEvaluateJavaScript("Basic.DrawArea.GetMapPointNameAndDevName()");
        }
        ...
        public void DoRemoveMapContextMenu(Axmetamap2dLib.AxMetaMapX2D mx)
        {
            //metamap2dLib.IMetaMapView view = mx.CurVisibleView();
            //if (view == null) return;
            mx.CurViewEvaluateJavaScript("Basic.DrawArea.RemoveAreaContextMenu()");
        }
        /// <summary>
        /// 设置是否开启坐标拾取功能
        /// </summary>
