...
{
    public partial class VideoPointDefEdit : XtraForm
    {
        ...
        public VideoPointDefEdit(string PointName, string UnitName, string BindType, string ZoomLevel, string animationState, string TurnToPage, string PointId)
        {
            InitializeComponent();
            EditPoint = PointName;
        ...
        private void VideoPointDefEdit_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //加载测点信息，包括交换机测点
                List<V_DefInfo> vdefinfos = Program.main.GraphOpt.LoadAllVideoPointDef();
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Point = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "IPAddress").ToString();
                string Wz = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Devname").ToString();
                string DevName = "视频";
