...
namespace Sys.Safety.Client.Display
{
    ...
    public partial class NetCuCharge : UserControl
    {
        public NetCuCharge()
        {
            InitializeComponent();
        ...
        public NetCuCharge(string StationPoint)
        {
        ...
        /// </summary>
        //DOTO:与其它业务模块相关联
        //private JCMACDTO tempStation = null;
        ...
        private void EvaluatePowerPackInf()
        {
            ...
            //    return;
            //}
            //tempStation = Model.ChargeMrg.QueryJcMac(_StationPoint);
            //if (tempStation == null)
            //{
            //    return;
            //}
        ...
        private void tlbRefresh_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //        return;
            //    }
            //    JCMACDTO Station = Model.ChargeMrg.QueryJcMac(_StationPoint);
            //    if (Station == null)
            //    {
            //        return;
            //    }
            //    Model.ChargeMrg.sendD(16, Station.MAC);//txy 20170330
            //}
            //catch (Exception ex)
            //{
            //    LogHelper.Error(ex);
        ...
        private void barSubItemExecute_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //                    // Model.ChargeMrg.DelJC_JCSDKZCache(tempControls[i].ID);//删除，改为调用批量接口 
