...
{
    public partial class RealBJControl : XtraForm
    {
        public RealBJControl()
        {
            ...
            lock (StaticClass.bjobj)
            {
                ...
                try
                {
                    ...
                    for (int kj = 0; kj < listkey.Count; kj++)
                    {
                        ...
                        type = jcb.Type;
                        //if (type == StaticClass.itemStateToClient.EqpState9 || type == StaticClass.itemStateToClient.EqpState11 ||
                        //    type == StaticClass.itemStateToClient.EqpState19 || type == StaticClass.itemStateToClient.EqpState21
                        //    || type == StaticClass.itemStateToClient.EqpState13 ||
                        //    type == StaticClass.itemStateToClient.EqpState16 ||
                        //    type == StaticClass.itemStateToClient.EqpState15)
                        if (type == StaticClass.itemStateToClient.EqpState9 || 
                            type == StaticClass.itemStateToClient.EqpState19|| type == StaticClass.itemStateToClient.EqpState13 ||
                            type == StaticClass.itemStateToClient.EqpState16 ||
                            type == StaticClass.itemStateToClient.EqpState15)
                        {
