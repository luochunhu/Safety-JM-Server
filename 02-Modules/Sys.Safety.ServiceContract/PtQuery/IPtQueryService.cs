...
namespace Sys.Safety.ServiceContract.App
{
    ...
    /// App接口
    /// </summary>
    public interface IPtQueryService
    {
        /// <summary> 
        /// 获取设备实时数据
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        BasicResponse<List<PointInfoDataContract>> GetAllPointDefineData();
        /// <summary>
        ...
        /// <param name="deraillineRequest"></param>
        /// <returns></returns>
        BasicResponse<List<DerailChartStateLineDataContract>> GetKGLStateLine(ChartGetRequest deraillineRequest);
        /// <summary>
        /// 模拟量日班报表
        /// </summary>
        /// <param name="analoglineRequest"></param>
        /// <returns></returns>
        BasicResponse<List<MnlDayReportDataContract>> GetMLLDayReport(GetDayReportRequest analoglineRequest);
        ...
        /// <returns></returns>
        BasicResponse<GetJCRDataResponse> GetJCRData(PointRunLogGetRequest runlogRequest);
