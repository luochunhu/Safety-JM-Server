...
{
    public class B_DefCache : KJ73NCacheManager<Jc_DefInfo>
    {
        private readonly IB_DefService bDefService;
        ...
        private static volatile B_DefCache _instance;
        /// <summary>
        /// 测点定义单例
        /// </summary>
        public static B_DefCache Instance
        {
            get
            {
                if (_instance == null)
        ...
        public B_DefCache()
        {
            bDefService = ServiceFactory.Create<IB_DefService>();
        }

        public override void Load()
        {
            var respose = bDefService.GetAll(new Basic.Framework.Web.BasicRequest());
